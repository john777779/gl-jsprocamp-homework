...
function getDataTypePseudoName(variable) {
  ...
  if (typeVariable === 'boolean' || typeVariable === 'number' || typeVariable === 'string') {
    return 'primitive';
  } else if (typeVariable === 'undefined' || variable === null) {
    return 'primitive-special';
  } else if (typeVariable === 'function') {
    return 'object-function';
  } else if (typeVariable === 'object' ) {
...
/*
  ...
  и в случае если аргумент не Infinity или NaN возвращает строку 'safe'
  иначе 'danger'
*/
...
function getStringPart(str) {
  ...
  return 'Error argument type';
}

/*
  Напишите функцию, которая принимает 2 аргумента (строку и симовл),
  и возвращает порядковый номер симовола в строе если символ встречается
  в строке 1 раз,
...
/*
  ...
  и возвращает строку ввиде элементов массива c разделителями если
  разделитель задан
...
/*
  ...
  и возвращает один состоящий из элементов перового и второго
  (последовательно сначала первый потом второй)
*/
